...
# @generated by pegen from regex_grammar/regex.gram
...
class GeneratedParser(Parser):
    ...
    def expr(self) -> Optional[Any]:
        # expr: or_expr | group_expr | optional_group_expr | rule_with_range_expr | rule_with_count_expr | rule_mention_expr | literal_expr
        mark = self._mark()
        if (
    ...
    @memoize
    def group_expr(self) -> Optional[Any]:
        # group_expr: '(' exprs ')'
        mark = self._mark()
        if (
            (self.expect('('))
